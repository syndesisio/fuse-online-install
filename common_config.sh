...
TAG_FUSE_ONLINE_INSTALL=1.8.21
...
CAMEL_K_IMAGE=registry.redhat.io/fuse7-tech-preview/fuse-camel-k:1.5
...
SYNDESIS_IMAGE=registry.redhat.io/fuse7/fuse-online-operator:1.5
