...
TAG_FUSE_ONLINE_INSTALL=1.9.12
...
CAMEL_K_IMAGE=registry.redhat.io/fuse7-tech-preview/fuse-camel-k-rhel7-operator:1.6
...
SYNDESIS_IMAGE=registry.redhat.io/fuse7/fuse-online-operator:1.6
