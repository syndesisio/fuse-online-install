...
#SYNDESIS_IMAGE=registry-proxy.engineering.redhat.com/rh-osbs/fuse7-fuse-online-rhel8-operator:1.11
SYNDESIS_IMAGE=registry.redhat.io/fuse7/fuse-online-rhel8-operator:1.11
