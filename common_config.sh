...
CAMEL_K_IMAGE=registry-proxy.engineering.redhat.com/rh-osbs/fuse7-tech-preview-fuse-camel-k:1.5-14
...
SYNDESIS_IMAGE=registry-proxy.engineering.redhat.com/rh-osbs/fuse7-fuse-online-operator:1.5-9
