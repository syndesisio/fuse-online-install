...
TAG_FUSE_ONLINE_INSTALL=1.14.0
...
SYNDESIS_IMAGE=registry-proxy.engineering.redhat.com/rh-osbs/fuse7-fuse-online-rhel8-operator:1.14
#SYNDESIS_IMAGE=registry.redhat.io/fuse7/fuse-online-rhel8-operator:1.14
